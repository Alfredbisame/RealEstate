    ...
    <div className="bg-blue-500 rounded-xl p-6 text-white shadow-lg">
      <div className="flex items-center justify-between mb-4">
        <div>
          ...
          <p className="text-blue-100 text-lg">Track daily attendance and generate comprehensive reports</p>
        </div>
        <div className="flex items-center space-x-3">
          <Button variant="outline" size="sm" className="bg-white bg-opacity-10 border-white border-opacity-20 text-white hover:bg-white hover:bg-opacity-20 dark:bg-gray-700 dark:bg-opacity-20 dark:border-gray-600 dark:text-gray-200 dark:hover:bg-gray-700 dark:hover:bg-opacity-30">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="bg-white bg-opacity-10 rounded-lg p-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-blue-200 text-xs">{attendanceRate}% attendance</p>
            </div>
        ...
        <div className="bg-white bg-opacity-10 rounded-lg p-4">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-blue-100 text-sm font-medium">Avg. Hours</p>
              <p className="text-2xl font-bold">{averageHours}h</p>
              <p className="text-blue-200 text-xs">Per worker</p>
            </div>
