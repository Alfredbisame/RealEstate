...
export default function QualityControlHeader() {
  return (
    <div className="bg-gradient-to-r from-green-500 to-blue-500 rounded-xl p-6 flex flex-col md:flex-row items-center justify-between shadow-lg">
      <div>
        <h2 className="text-2xl font-bold text-white mb-1">Quality Control Checklists</h2>
        <p className="text-white/80 text-sm">Stage-by-stage quality assurance and compliance tracking</p>
      </div>
