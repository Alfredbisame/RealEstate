...
export default function SalesPipelineHeader({ user }: SalesPipelineHeaderProps) {
  return (
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="space-y-2">
          ...
          <p className="text-purple-700 dark:text-purple-300 text-lg">
            Track and manage deals from inquiry to closing with comprehensive pipeline insights
          </p>
        </div>
        <div className="flex items-center space-x-3">
