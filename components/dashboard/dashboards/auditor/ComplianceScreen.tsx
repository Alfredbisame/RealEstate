...
export default function ComplianceScreen() {
  ...
  return (
    <div className="bg-gradient-to-br from-white via-gray-50 to-gray-100 dark:from-gray-800 dark:via-gray-750 dark:to-gray-700 rounded-2xl p-0 border border-gray-200 dark:border-gray-800 flex flex-col min-h-screen h-screen">
