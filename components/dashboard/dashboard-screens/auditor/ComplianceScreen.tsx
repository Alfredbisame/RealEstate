...
export default function ComplianceScreen() {
  ...
  return (
    <div className="bg-blue-50 dark:bg-gray-800 rounded-2xl p-0 border border-gray-200 dark:border-gray-700 flex flex-col min-h-screen h-screen">
      <div className="bg-blue-500 rounded-t-2xl p-4 md:p-8 flex flex-col md:flex-row items-center justify-between shadow-lg">
        <div>
          <h2 className="text-xl md:text-3xl font-extrabold text-white mb-1 tracking-tight">Regulatory Compliance Overview</h2>
          <p className="text-white text-sm md:text-base font-medium">Monitor regulatory, tax, labor, and financial compliance. Read-only access for auditors.</p>
        </div>
      </div>
      <div className="flex-1 min-h-0 flex flex-col px-2 md:px-8 pt-2 md:pt-6 pb-2 md:pb-8 gap-4 md:gap-8">
        ...
        <div className="sticky top-0 z-10 bg-blue-50 dark:bg-gray-800 rounded-t-2xl md:rounded-2xl shadow-sm border-b border-gray-200 dark:border-gray-700 px-2 md:px-8 pt-2 md:pt-6 pb-2 md:pb-4 flex flex-col gap-2 md:gap-4">
